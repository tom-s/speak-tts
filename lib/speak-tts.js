...
var SpeakTTS = /*#__PURE__*/function () {
  ...
  _createClass(SpeakTTS, [{
    ...
    value: function init() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this._loadVoices().then(function (voices) {
          ...
          !(0, _utils.isNil)(splitPhrases) && _this.setSplitPhrases(splitPhrases);
          resolve({
            voices: voices,
            lang: _this.lang,
            voice: _this.voice,
            ...
            splitPhrases: _this.splitPhrases,
    ...
    key: "setSplitPhrases",
    value: function setSplitPhrases(splitPhrases) {
    ...
    value: function speak(data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var utterances = []; // Always split by phrases if it is true.
        // Only split by sentences if splitSentences == true && splitPhrases == false

        var sentences = _this3.splitPhrases ? (0, _utils.splitPhrases)(msg) : _this3.splitSentences ? (0, _utils.splitSentences)(msg) : [msg];
        sentences.forEach(function (sentence, index) {
          ...
          utterance.text = sentence; // Attach event listeners, and make sure onerror and onend are included
