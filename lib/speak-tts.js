  ...
  _createClass(SpeakTTS, [{
    ...
    value: function init(conf) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var listeners = (0, _utils.get)(conf, 'listeners', {});
        var splitSentences = (0, _utils.get)(conf, 'splitSentences', true);
        var lang = (0, _utils.get)(conf, 'lang');
        var volume = (0, _utils.get)(conf, 'volume', 1);
        var rate = (0, _utils.get)(conf, 'rate', 1);
        var pitch = (0, _utils.get)(conf, 'pitch', 1);
        var voice = (0, _utils.get)(conf, 'voice'); // Attach event listeners
        ...
        _this._loadVoices().then(function (voices) {
          ...
          lang != null && _this.setLanguage(lang);
          voice != null && _this.setVoice(voice);
          volume != null && _this.setVolume(volume);
          rate != null && _this.setRate(rate);
          pitch != null && _this.setPitch(pitch);
          splitSentences != null && _this.setSplitSentences(splitSentences);
          resolve({
            voices: voices,
            lang: _this.lang,
            voice: _this.voice,
    ...
    value: function speak(data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (msg == null) resolve(); // Stop current speech
