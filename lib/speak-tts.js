...
var SpeakTTS = function (window) {
  ...
  var _splitSentences = function _splitSentences(text) {
    ...
    return _lodash2.default.chain(sentences).map(_lodash2.default.trim).compact().value();
  };
  ...
  var init = function init(conf) {
    ...
    if (!browserSupport()) {
      ...
      if ('onvoiceschanged' in window.speechSynthesis) {
        speechSynthesis.onvoiceschanged = _lodash2.default.debounce(function () {
  ...
  var speak = function speak(data) {
    var msg = _lodash2.default.trim(_lodash2.default.get(data, 'text'));
    var onEnd = _lodash2.default.get(data, 'onEnd');
    var onError = _lodash2.default.get(data, 'onError');
    ...
    _lodash2.default.forEach(sentences, function (sentence) {
      var utterance = new window.SpeechSynthesisUtterance();
      var voice = _lodash2.default.find(window.speechSynthesis.getVoices(), function (voice) {
