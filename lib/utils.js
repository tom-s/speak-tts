...
exports.trim = exports.isObject = exports.isNil = exports.isNan = exports.size = exports.isString = exports.validateLocale = exports.splitPhrases = exports.splitSentences = void 0;
...
var splitPhrases = function splitPhrases() {
  var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  return text.replace(/\.+/g, '.|').replace(/\?/g, '?|').replace(/\!/g, '!|').replace(/\,/g, ',|').replace(/\:/g, ':|').replace(/\;/g, ';|').split("|").map(function (sentence) {
    return trim(sentence);
  }).filter(Boolean);
};

exports.splitPhrases = splitPhrases;
